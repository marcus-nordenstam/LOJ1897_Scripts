...
(npc-reflex {?actor wrong-act @self}:?c
  (effects
    ...
    (mint-pressure [k humiliation] ?actor 720)
    (mint-pressure [k injustice] ?actor 2160)
...
(npc-reflex {?actor betray-act @self}:?c
  (effects
    ...
    (mint-pressure [k attachment-loss] ?actor 2160)
...
(npc-reflex {?actor repudiation-act @self}:?c
  (effects
    ...
    (mint-pressure [k status-loss] @nothing 4320)
    (mint-pressure [k attachment-loss] ?actor 1440)
    (end-bond {@self love ?actor})
    (end-bond {@self friend ?actor})))
