...
; a trait off anyone else: each competitor SELF-simulates his run (RACE-RUN.mc) and
...
; (sporting_event_think.mc) reads the roster and proposes one directed SAY per
