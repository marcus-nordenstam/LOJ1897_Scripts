...
;     re-checks the urge; the (days-since-last @self PLAY-GAME) fire-gate mints the
...
; when-unsupported-effects end the enter-goal. The enter chain steps the gambler INSIDE the pub, so
