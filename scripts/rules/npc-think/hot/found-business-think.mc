...
;; ----------------------------------------------------------------------------
;; found_business (npc-think) - the THINK half of the business-founding split.
;;
...
;; - no dwell rung.
;;
;; Utility 85 beats the work aspect (80) so a man set on founding pursues it rather
...
;; bank). Mirrors the drinking aspect's (can-drink) at-a-pub gate.
;(npc-think found_go
;  (goal {@self FOUND})
...
;  (goal    {@self FOUND})
;  (when    (is-a (spatial @self building) [k building bank]))
