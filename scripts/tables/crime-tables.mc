...
; Skill-affinity map: an actor skilled-in <domain> picks the mapped methods more readily
...
(define-table skill_affinity
  ...
  (record [k poisoning-knowledge]   poison)
  (record [k medicine]              poison)
  (record [k marksmanship]          shoot)
  (record [k knife-fighting]        stab)
  (record [k knife-fighting]        slash)
