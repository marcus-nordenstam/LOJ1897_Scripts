# One left hand per human; capacity covers human-npc (4096) + human-player (256).
#
...
# its own rig bone.
archetype "left-hand" (cap 4352) (per obs) (non-occluder)
{
    ...
    # is created.
    (struct child "ring-finger" [k left-ring-finger] (offset 0 0 0))
    (attr "wear")
    (spatial bounds)
