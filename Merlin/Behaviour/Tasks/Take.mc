...
{@self take ?thing}
(in_range /reach /not ?thing 0.5 /stay_at 0.3 /debug)
    ->
(maintainProposal {@self go_entity ?thing} (abs_util 2000)).
...
(in_range /reach ?thing 0.5 /stay_at 0.3 /debug)
(lockRule take 0)
    ->
(maintainProposal {@self LOOK_AT ?thing} (abs_util 2000))
(maintainProposal {@self TURN_TO ?thing} (abs_util 2000))
(maintainProposal {@self LEFT_REACH_FOR ?thing} (abs_util 2000)).
...
(maintainProposal {@self LOOK_AT ?thing} (abs_util 2000))
(maintainProposal {@self TURN_TO ?thing} (abs_util 2000))
(maintainProposal {@self RIGHT_REACH_FOR ?thing} (abs_util 2000)).
...
{@self LEFT_REACH_FOR ?thing /succ}
    ->
(beginProposal {@self LEFT_GRASP ?thing} (abs_util 2000)).

rule take-right-grasp-proposal
{@self take ?thing}
{@self RIGHT_REACH_FOR ?thing /succ}
    ->
(beginProposal {@self RIGHT_GRASP ?thing} (abs_util 2000)).
