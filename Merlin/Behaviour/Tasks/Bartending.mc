...
(claim_env_cell (des behind ?bar_counter) (des near ?patron)): ?talk_cell
...
(claim_env_cell (env_cell_size [k drinking_glass]) (des on_top_of ?bar_counter) (des near ?patron) /debug): ?cell
    ->
