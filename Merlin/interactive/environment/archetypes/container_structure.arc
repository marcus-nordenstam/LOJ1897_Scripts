...
archetype "container-structure" (cap 2048) (per obs) (always-visible) (children-occupy-env-grid)
{
    ...
    # commute via exterior perception and internalizes {building struct-status [k closed]}
