...
# Marital status is not stored - it is derived wherever it is needed from the
# ongoing spouse / fiancee beliefs (ongoing spouse = married, ongoing fiancee
# = engaged, neither ever held = single). The rules below establish those
# spouse / fiancee beliefs for OTHERS by examining the rings on the person's
