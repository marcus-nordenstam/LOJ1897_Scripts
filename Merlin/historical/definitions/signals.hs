...
; ----------------------------------------------------------------------------
; Conduct trait dimensions (Shape V value-only) - temperamental priors read on
; demand via (classifier-value ...). A plain mean of the (possibly inverted)
; Big-Five / dark-tetrad aspects, read @self-only ((attr ...) is the mind's own
; entity). No float belief is minted.
; ----------------------------------------------------------------------------
