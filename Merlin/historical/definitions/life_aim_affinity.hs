...
(life-aim-affinity power_aim   discredit      0.4)
...
(life-aim-affinity respectability_aim  discredit      0.2)
...
(life-aim-affinity piety_aim   discredit     -0.3)
...
(life-aim-affinity belonging_aim  discredit    -0.3)
