...
;                                             ; CONFERS competence in (S4 derives
;                                             ; {@self skilled_in <leaf>} from tenure)
...
;
; Job names MUST match Concepts.mon. Domain leaves MUST be `domain` sub-kinds.
; Repute bands are `respectability_situation` leaves; trait names are personality
; attrs (common.arc).
; ----------------------------------------------------------------------------
...
(job industrialist (class_floor upper)  (business_type factory)        (may_own true)  (era_min 1830) (domain engineering)
   (req_repute respectable) (req_skill engineering trained)
   (pref_trait assertiveness 1.0) (pref_trait industriousness 0.8))
(job landlord      (class_floor middle)                                (may_own true)  (era_min 1700) (domain commerce)
   (req_repute respectable)
   (pref_trait assertiveness 0.8) (pref_trait industriousness 0.6))
...
(job physician     (class_floor middle) (business_type hospital)       (may_own false) (era_min 1700) (domain medicine)
   (req_repute respectable) (req_skill medicine trained)
   (pref_trait compassion 0.8) (pref_trait industriousness 0.8))
...
(job principal     (class_floor middle) (business_type private_school) (may_own false) (era_min 1700) (domain secondary_school_curriculum)
   ...
   (pref_trait politeness 0.8) (pref_trait industriousness 0.8))
...
(job professor     (class_floor upper)  (business_type university)     (may_own false) (era_min 1700)
   (req_repute respectable)
   (pref_trait openness 1.0) (pref_trait industriousness 0.6))
...
(job editor        (class_floor middle) (business_type newspaper)      (may_own true)  (era_min 1750) (domain literature)
   (req_repute respectable) (req_skill literature trained)
   (pref_trait openness 0.8) (pref_trait assertiveness 0.6))
...
(job journalist    (class_floor middle) (business_type newspaper)      (may_own false) (era_min 1750) (domain literature)
   (pref_trait openness 1.0) (pref_trait enthusiasm 0.6))
...
(job teacher       (class_floor middle) (business_type state_school)   (may_own false) (era_min 1700) (domain secondary_school_curriculum)
   (req_repute respectable) (req_skill secondary_school_curriculum novice)
   (pref_trait politeness 0.8) (pref_trait compassion 0.6))
