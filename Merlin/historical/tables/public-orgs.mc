...
; head_pos MUST be a HEAD kind (is-a head_of_non_household_org) - the one-org
...
(define-table public_orgs
  ...
  (record [k org land_registry]    1700 [k job superintendent] 2 clerk    [k lower])
  (record [k org company_registry] 1700 [k job superintendent] 2 clerk    [k lower])
  (record [k org house_agency]     1700 [k job superintendent] 2 clerk    [k lower])
  ...
  (record [k org meeting_hall]     1700 [k job superintendent] 1 clerk    [k lower])
  (record [k org sports_ground]    1700 [k job superintendent] 1 gardener [k lower]))
