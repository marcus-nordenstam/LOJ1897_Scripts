...
(job banker        (class_floor middle) (business_type bank)           (may_own true)  (era_min 1700))
...
(job solicitor     (class_floor middle) (business_type solicitor_firm) (may_own true)  (era_min 1700))
