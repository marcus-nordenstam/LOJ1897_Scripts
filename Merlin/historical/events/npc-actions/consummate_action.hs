...
;
; The begun-then-ended {@self HAVE_SEX_WITH ?paramour} act-belief IS the record on
...
; attraction. HAVE_SEX_WITH carries the (abduct) decoration, so committing it lets
...
(npc-action {@self HAVE_SEX_WITH ?paramour}
  (duration 45)
  (effects
