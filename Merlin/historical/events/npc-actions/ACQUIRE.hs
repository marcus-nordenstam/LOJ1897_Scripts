...
;      memory of setting out to arm) so it promotes to acquire_action;
;   2. acquire_action dwells the round-trip travel time, then (at completion) acquires
