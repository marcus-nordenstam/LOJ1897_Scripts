; ----------------------------------------------------------------------------
; buy_home - the npc-ACT half of the purchase demand (buy_home.hs), promoted at
; a house agent's office.
;
;   BUY_HOME : the sale, from the BUYER's side only (no cross-mind writes). It
