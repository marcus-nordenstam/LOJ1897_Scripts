...
;
; cont-fire-effects (not first-fire, not the banned (effects ...)): a (long-term-think)
; runs in the window-start pass, OUTSIDE the intra-day cascade, where the first-fire
; lifecycle latch never arms - so a long-term-think authors its effects in cont-fire,
