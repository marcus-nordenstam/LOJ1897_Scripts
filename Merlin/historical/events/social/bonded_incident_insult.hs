...
; same victim monthly. chance dilutes by victim-population scale.
;
; The structural amplifiers from the plan's row (stress, intoxication,
; prestige-gap-either-way) are V3 work - V2 ships the trait gradient
; alone to validate the multiplicative shape.
;
; Schedule: monthly.
; ----------------------------------------------------------------------------
