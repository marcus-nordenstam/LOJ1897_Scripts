...
; whole file compiles to nothing shipped. A rule with a standing (when) fires ONCE per
...
(npc-think audit_unanswered_application
  (cooldown 1 d)
...
(npc-think audit_hired_never_worked
  (cooldown 1 d)
...
; every window.
(npc-think audit_offers_vs_seats
  (cooldown 1 d)
  (cease-after-fire)
...
(npc-think audit_two_verdicts_one_man
  (cooldown 1 d)
  (role @self {@self duty-to ?org recruit-staff})
...
(npc-think apply-for_audit_two_in_flight
