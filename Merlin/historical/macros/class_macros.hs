...
(define-macro class-band (?who)
  (if (believes {?who class_situation [k class_situation upper]})  (then 2)
  (else (if (believes {?who class_situation [k class_situation middle]}) (then 1)
      (else (if (believes {?who class_situation [k class_situation lower]}) (then 0)
          (else -1)))))))
