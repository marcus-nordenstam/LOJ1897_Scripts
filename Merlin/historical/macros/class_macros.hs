...
(define-macro class-band (?who)
  (if (any {?who class_situation [k class_situation upper]} (out int))  (then 2)
  (else (if (any {?who class_situation [k class_situation middle]} (out int)) (then 1)
      (else (if (any {?who class_situation [k class_situation lower]} (out int)) (then 0)
          (else -1)))))))
