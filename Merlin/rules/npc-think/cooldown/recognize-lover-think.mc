...
; Whenever @self holds a PAST-YEAR HAVE-SEX-WITH record with someone who is NOT his
...
; record HAVE-SEX-WITH writes on the paramour), so the bond forms on BOTH sides with NO
