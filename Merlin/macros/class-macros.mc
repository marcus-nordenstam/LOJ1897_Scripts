...
(define-macro class-band (?who)
  (cond
    (case {?who class-situation [k class-situation upper]}  2)
    (case {?who class-situation [k class-situation middle]} 1)
    (case {?who class-situation [k class-situation lower]}  0)
    (else -1)))
